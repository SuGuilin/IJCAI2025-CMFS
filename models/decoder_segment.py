...
class SegmentTaskHead(nn.Module):
    def __init__(self,
        ...
        super(SegmentTaskHead, self).__init__()
        ...
        self.linear_fuse = nn.Sequential(
                            ...
                            Permute(0, 2, 3, 1),
                            SS2D(d_model=embedding_dim, d_state=16, drop_path=0., norm_layer=nn.LayerNorm, attn_drop_rate=0, expand=2.0, ),
